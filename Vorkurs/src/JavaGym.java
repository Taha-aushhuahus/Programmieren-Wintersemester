public class JavaGym {
	...
	public static boolean istEinstellig(int x) {
		...
		return x<10 && x>-10 ; // Bitte ersetzen Sie diese Zeile durch Ihre Loesung.
	}
	...
	public static int flaecheninhalt(int x1, int x2, int y1, int y2) {
		...
		int jonaseier= x1-x2*y1-y2;
		if (jonaseier<0) {
			return jonaseier*-1;
			
		} else {return jonaseier;
	}  // Bitte ersetzen Sie diese Zeile durch Ihre Loesung.
}	
	...
	public static boolean istZweistellig(int x) {
		...
		return x>-100 && x<100 && !istEinstellig(x); // Bitte ersetzen Sie diese Zeile durch Ihre Loesung. 
	}
	...
	public static int summeBis(int n) {
		...
		}return ergebnis; // Bitte ersetzen Sie diese Zeile durch Ihre Loesung.
	}
	...
	public static String glockenschlag(int stunden, int minuten) {
		...
		if (minuten==15){
			ergebnis=ergebnis+"Bim";
		}	else if (minuten==30){
			ergebnis=ergebnis+"BimBim";
		} else if (minuten==45) {
			ergebnis=ergebnis+"BimBimBim";
		} else if (minuten==0) {
			ergebnis=ergebnis+"BimBimBimBim";
			for (int i = 0; i < stunden; i++) {
				ergebnis=ergebnis+"Bam";
